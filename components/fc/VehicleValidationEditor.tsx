...
export default function VehicleValidationEditor({ costCode: costCodeProp }) {
  ...
  const handleShowInvoicePreview = async () => {
    ...
    try {
      ...
      const invoiceData = {
        ...
        billing_month:
          String(liveInvoice?.billing_month || billingMonth).trim() || null,
        company_name: liveInvoice?.company_name || previewTitle,
