...
import { Search, Plus, Package, TrendingUp, TrendingDown } from 'lucide-react';
...
export default function StockLedger() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Stock Ledger</h2>
        <p className="text-gray-600">Monitor all stock movements and transactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">0</div>
            <p className="text-xs text-gray-500">Items dispatched</p>
          </CardContent>
        </Card>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-600">Movement Type</th>
                ...
                <tr>
                  <td colSpan="7" className="text-center py-12 text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-lg font-medium text-gray-400 mb-2">No stock movements found</p>
                      <p className="text-sm text-gray-400">Stock movements will appear here once you start managing inventory</p>
                    </div>
                  </td>
                </tr>
              </tbody>
