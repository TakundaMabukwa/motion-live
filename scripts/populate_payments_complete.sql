...
BEGIN
    FOR vehicle_record IN 
        SELECT 
            ...
            fleet_number,
            reg,
            -- Calculate totals by category including ALL columns
            ...
            (COALESCE(NULLIF(beame_1_rental, '')::NUMERIC, 0) +
             ...
             COALESCE(NULLIF(dual_probe_sub, '')::NUMERIC, 0)) AS beame_total,
            ...
            (COALESCE(NULLIF(_4ch_mdvr_rental, '')::NUMERIC, 0) +
             ...
             COALESCE(NULLIF(vw100ip_driver_facing_rental, '')::NUMERIC, 0)) AS camera_total,
            ...
            (COALESCE(NULLIF(pfk_main_unit_rental, '')::NUMERIC, 0) +
             ...
             COALESCE(NULLIF(pfk_main_unit_sub, '')::NUMERIC, 0)) AS pfk_total,
            
            COALESCE(NULLIF(roaming, '')::NUMERIC, 0) AS roaming_total,
    ...
    LOOP
        ...
        INSERT INTO payments_ (
            ...
            CURRENT_TIMESTAMP,
            'VEH-' || vehicle_record.id || ' | Skylink: R' || vehicle_record.skylink_total || 
            ' | Sky: R' || vehicle_record.sky_total ||
            ' | Beame: R' || vehicle_record.beame_total ||
            ' | Camera: R' || vehicle_record.camera_total ||
            ' | PFK: R' || vehicle_record.pfk_total ||
            ' | Roaming: R' || vehicle_record.roaming_total ||
            ' | Services: R' || vehicle_record.services_total
        )
