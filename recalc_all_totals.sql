-- Query 1: Zero totals system-wide
UPDATE vehicles_duplicate SET total_rental = 0, total_sub = 0, total_rental_sub = 0;

-- Query 2: Recalculate from all billing columns dynamically (handles R prefix)
